                    ...
                    <div class="group-card">
                        <div class="card-header">
                            <div class="group-header">
                                <div>
                                    <h3 class="group-title"><?php echo e($group['name']); ?></h3>
                                    <p class="group-subtitle"><?php echo e($group['fillier']); ?> - <?php echo e($group['niveau']); ?></p>
                                </div>
                                <div class="group-meta">
                                    <span class="badge"><?php echo e(count($group['modules'])); ?> Modules</span>
                                </div>
                            </div>
                        </div>
                                ...
                                <?php $__currentLoopData = $group['modules']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="module-card">
                                        <div class="module-header">
                                            <div>
                                                <h4 class="module-title"><?php echo e($module['name']); ?></h4>
                                                <p class="module-code">Code : <?php echo e($module['code']); ?></p>
                                            </div>
                                            <span
                                                class="status-badge 
                                            <?php echo e($module['completed_hours'] >= $module['total_hours']
                                                ? 'status-completed'
                                        ...
                                        <div class="module-stats">
                                            <div class="stat-item">
                                                ...
                                                <p class="stat-value"><?php echo e($module['total_hours']); ?></p>
                                            </div>
                                            <div class="stat-item">
                                                <p class="stat-label">Complété</p>
                                                <p class="stat-value"><?php echo e($module['completed_hours']); ?></p>
                                            </div>
                                            <div class="stat-item">
                                                <p class="stat-label">Date d'examen</p>
                                                <p class="stat-value"><?php echo e($module['exam_date'] ?? 'Non définie'); ?></p>
                                            </div>
                                            <div class="stat-item">
                                                <p class="stat-label">Progression</p>
                                                <p class="stat-value">
                                                    <?php echo e(number_format(($module['completed_hours'] / $module['total_hours']) * 100, 1)); ?>%
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="progress-container">
                                            ...
                                            <span
                                                class="progress-percentage"><?php echo e(number_format(($module['completed_hours'] / $module['total_hours']) * 100, 1)); ?>%</span>
                                            <progress value="<?php echo e($module['completed_hours']); ?>"
                                                max="<?php echo e($module['total_hours']); ?>"></progress>
                                            <p class="progress-text">
                                                <?php echo e($module['completed_hours']); ?>h/<?php echo e($module['total_hours']); ?>h</p>
                                        </div>
                                    </div>
...
<?php endif; ?>
<?php /**PATH C:\school\stage\calendar_ista\calendar_ista\ista_management\resources\views/formateur/dashboard.blade.php ENDPATH**/ ?>