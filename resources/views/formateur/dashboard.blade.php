...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/formateur_calendar" aria-expanded="true"
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{route('formateur.dashboard')}}" aria-expanded="true"
                    aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Dashboard</span>
                </a>
                        ...
                        <div class="max-w-7xl mx-auto py-6 px-4">
                            @if($groups->isEmpty())
                                <div class="text-center py-8">
                                    <h2 class="text-xl text-gray-600">No groups assigned yet</h2>
                                    <p class="text-gray-500 mt-2">Please contact your administrator for group assignments.</p>
                                </div>
                            @else
                                <!-- Groups Overview -->
                                    ...
                                    <div class="bg-white rounded-lg shadow p-6">
                                        ...
                                        <div class="space-y-4">
                                            @if(!empty($group['modules']))
                                                ...
                                                @endforeach
                                            @else
                                                <p class="text-gray-500 text-center py-4">No modules assigned to this group</p>
                                            @endif
                                        </div>
                        
                                        <!-- Group Actions -->
                                        <div class="mt-4 flex justify-end">
                                            <a href="{{ route('formateur.group.detail', $group['id']) }}" 
